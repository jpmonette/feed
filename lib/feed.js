...
function Feed(options) {
    ...
    // DEPRECATED - replaced by addItem(options) and addCategory(category)
    this.item     = function (options)  { return this.addItem(options); }
    this.category = function (category) { return this.addCategory(category); }
};
