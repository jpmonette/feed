...
function atom_1_0(options) {
	...
	// check if the entry has any related links attached to it
	if (entries[i].relatedLinks == undefined || entries[i].relatedLinks.length <= 0) {
			
		// something really should happen at render-time, not here.
